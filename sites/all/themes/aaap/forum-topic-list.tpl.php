...
<?php $forum = forum_forum_load($tid = $topic_id); ?>
<?php $title = $forum->name; ?>
<?php $description = $forum->description; ?>
<div class="bc">
    <a href="/forum/">Forums</a>
    >
    <a href="javascrip:void(0)"><?php echo $title; ?></a>
</div>
<br/>
<hi class="title_blue_one"><?php echo $title; ?></hi>
<?php if (user_is_logged_in()): ?>
    <ul class="action-links">
        <li>
            <a href="/node/add/forum">Add new Forum topic</a>
            <div class="description"><small>A <em>forum topic</em> starts a new discussion thread within a forum.</small></div>
        </li>
    </ul>
<?php endif; ?>
<div class='clear'></div>
<br/>
<table id="forum-topic-<?php print $topic_id; ?>" class="aapa-forum-table">
    <thead>
