...
define('ADMIN_MAIL', 'drames@email.chop.edu, dawn@thinkcreativegroup.com, ztan@iu.edu, mdeguire@ucsd.edu'); //execute change_admin_callback() as well
//define('ADMIN_MAIL', 'ackermaj@MSKCC, drames@email.chop.edu, dawn@thinkcreativegroup.com, ztan@iu.edu, mdeguire@ucsd.edu'); define('ADMIN_MAIL', 'giovanny.sayas@akendos.com, maicol.lopez@akendos.com');//execute change_admin_callback as well
