 ...
 */
global $user;
$show_actions_link = FALSE;
if (is_array($user->roles) && user_is_logged_in()) {
    $data['show_query'] = TRUE;
    if (in_array('Super Administrator', $user->roles)) {
        $show_actions_link = TRUE;
    }
}
?>
<hi class="title_blue_one">Forums</hi>
<?php if ($show_actions_link): ?>
    <ul class="action-links">
        <li><a href="/admin/structure/forum/add/forum">Add new forum</a></li>
    </ul>
<?php endif; ?>
<div class='clear'></div>
<br/>
<table id="forum-<?php print $forum_id; ?>" class="aapa-forum-table">
    <thead>
        <tr bgcolor="#245383" style="color:#FFF;">
